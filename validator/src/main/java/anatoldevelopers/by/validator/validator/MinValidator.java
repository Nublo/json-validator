...
public class MinValidator extends AbstractValidator {
    ...
    public MinValidator(String message, String value) {
    ...
    public List<ValidationError> validate(Field field, Object fieldValue) {
        ...
        if (fieldValue == null || minNumber(fieldValue)) {
    ...
    private boolean minNumber(Object fieldValue) {
        return compareTo(Double.parseDouble(value), (Number) fieldValue) > 0;
    }
    ...
    public String toString() {
        return "MinValidator{ " + super.toString() + "}";
    }
}
